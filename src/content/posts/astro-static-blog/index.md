...
![Astro 정적 블로그 구축 4단계 — 컬렉션 정의, 글 작성, 페이지 렌더링, GitHub Pages 배포 요약](./images/thumbnail.png)
...
![glob() 로더와 Zod 스키마로 src/content/blog의 Markdown을 타입 안전한 콘텐츠 컬렉션으로 묶는 구조 다이어그램](./images/body-1.png)
...
![main 브랜치 push에서 withastro/action 빌드, actions/deploy-pages 배포로 이어지는 GitHub Actions 워크플로 단계별 다이어그램](./images/body-2.png)
